...
class Results:
    ...
    def parser_label(self):
        ...
        split_point = np.where(diff>0.8)[0] # 0.8
...
def main(root_item, dataset, model, test_id, root='./new_results_v9'):
...
if __name__ == '__main__':
    ROOT = './new_results_v10'
    # ROOT = './new_results_v7_table4'
    # main('PINNdebug', 'CS2', 'Ours', 'CS2_35', root = ROOT)
    # main('PINNdebug', 'CS2', 'Ours', 'CS2_36', root = ROOT)
    # main('PINNdebug', 'CS2', 'Ours', 'CS2_37', root = ROOT)
    # main('PINNdebug', 'CS2', 'Ours', 'CS2_38', root = ROOT)

    main('PINNv2', 'CS2', 'PINN', 'CS2_35', root = ROOT)
    main('PINNv2', 'CS2', 'PINN', 'CS2_36', root = ROOT)
    main('PINNv2', 'CS2', 'PINN', 'CS2_37', root = ROOT)
    main('PINNv2', 'CS2', 'PINN', 'CS2_38', root = ROOT)
