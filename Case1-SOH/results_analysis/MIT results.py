...
if __name__ == '__main__':
    root = '/workspace/code/nc_proj/soh_pinn_v2/PINN4SOH-main/new_results_v8_table5/results of PINNv2/MIT results'
    writer = pd.ExcelWriter('/workspace/code/nc_proj/soh_pinn_v2/PINN4SOH-main/new_results_v8_table5/PINN-MIT_results.xlsx')
