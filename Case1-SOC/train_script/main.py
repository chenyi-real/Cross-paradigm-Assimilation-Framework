...
import inspect
import config
from config import DATA_DIR, CSV_FILES, DEVICE, RESULTS_XLSX, PLOTS_DIR, PLOT
from dataloader import load_one_csv
from train import seed_everything, train_tcn_on_table, compute_metrics
...
def main():
    ...
    cfg_path = os.path.join(config.EXP_DIR, "config.yaml")
